...
const musicTracks = [
  ...
  // ==========================================
  { title: 'C418 - Key (Volume Alpha)', url: '/Radio/01. Key.mp3' },
  { title: 'C418 - Door (Volume Alpha)', url: '/Radio/02. Door.mp3' },
  { title: 'C418 - Subwoofer Lullaby (Volume Alpha)', url: '/Radio/03. Subwoofer Lullaby.mp3' },
  { title: 'C418 - Death (Volume Alpha)', url: '/Radio/04. Death.mp3' },
  { title: 'C418 - Living Mice (Volume Alpha)', url: '/Radio/05. Living Mice.mp3' },
  { title: 'C418 - Moog City (Volume Alpha)', url: '/Radio/06. Moog City.mp3' },
  { title: 'C418 - Haggstrom (Volume Alpha)', url: '/Radio/07. Haggstrom.mp3' },
  { title: 'C418 - Minecraft (Volume Alpha)', url: '/Radio/08. Minecraft.mp3' },
  { title: 'C418 - Oxygene (Volume Alpha)', url: '/Radio/09. Oxygene.mp3' },
  { title: 'C418 - Equinoxe (Volume Alpha)', url: '/Radio/10. Equinoxe.mp3' },
  { title: 'C418 - Mice on Venus (Volume Alpha)', url: '/Radio/11. Mice on Venus.mp3' },
  { title: 'C418 - Dry Hands (Volume Alpha)', url: '/Radio/12. Dry Hands.mp3' },
  { title: 'C418 - Wet Hands (Volume Alpha)', url: '/Radio/13. Wet Hands.mp3' },
  { title: 'C418 - Clark (Volume Alpha)', url: '/Radio/14. Clark.mp3' },
  { title: 'C418 - Chris (Volume Alpha)', url: '/Radio/15. Chris.mp3' },
  { title: 'C418 - Thirteen (Volume Alpha)', url: '/Radio/16. Thirteen.mp3' },
  { title: 'C418 - Excuse (Volume Alpha)', url: '/Radio/17. Excuse.mp3' },
  { title: 'C418 - Sweden (Volume Alpha)', url: '/Radio/18. Sweden.mp3' },
  { title: 'C418 - Cat (Volume Alpha)', url: '/Radio/19. Cat.mp3' },
  { title: 'C418 - Dog (Volume Alpha)', url: '/Radio/20. Dog.mp3' },
  { title: 'C418 - Danny (Volume Alpha)', url: '/Radio/21. Danny.mp3' },
  { title: 'C418 - Beginning (Volume Alpha)', url: '/Radio/22. Beginning.mp3' },
  { title: 'C418 - Droopy Likes Ricochet (Volume Alpha)', url: '/Radio/23. Droopy Likes Ricochet.mp3' },
  { title: 'C418 - Droopy Likes Your Face (Volume Alpha)', url: '/Radio/24. Droopy Likes Your Face.mp3' },

  // ==========================================
  // 🔥 MINECRAFT - VOLUME BETA
  // ==========================================
  { title: 'C418 - Ki (Volume Beta)', url: '/Radio/01. Ki.mp3' },
  { title: 'C418 - Alpha (Volume Beta)', url: '/Radio/02. Alpha.mp3' },
  { title: 'C418 - Dead Voxel (Volume Beta)', url: '/Radio/03. Dead Voxel.mp3' },
  { title: 'C418 - Blind Spots (Volume Beta)', url: '/Radio/04. Blind Spots.mp3' },
  { title: 'C418 - Flake (Volume Beta)', url: '/Radio/05. Flake.mp3' },
  { title: 'C418 - Moog City 2 (Volume Beta)', url: '/Radio/06. Moog City 2.mp3' },
  { title: 'C418 - Concrete Halls (Volume Beta)', url: '/Radio/07. Concrete Halls.mp3' },
  { title: 'C418 - Biome Fest (Volume Beta)', url: '/Radio/08. Biome Fest.mp3' },
  { title: 'C418 - Mutation (Volume Beta)', url: '/Radio/09. Mutation.mp3' },
  { title: 'C418 - Haunt Muskie (Volume Beta)', url: '/Radio/10. Haunt Muskie.mp3' },
  { title: 'C418 - Warmth (Volume Beta)', url: '/Radio/11. Warmth.mp3' },
  { title: 'C418 - Floating Trees (Volume Beta)', url: '/Radio/12. Floating Trees.mp3' },
  { title: 'C418 - Aria Math (Volume Beta)', url: '/Radio/13. Aria Math.mp3' },
  { title: 'C418 - Kyoto (Volume Beta)', url: '/Radio/14. Kyoto.mp3' },
  { title: 'C418 - Ballad of the Cats (Volume Beta)', url: '/Radio/15. Ballad of the Cats.mp3' },
  { title: 'C418 - Taswell (Volume Beta)', url: '/Radio/16. Taswell.mp3' },
  { title: 'C418 - Beginning 2 (Volume Beta)', url: '/Radio/17. Beginning 2.mp3' },
  { title: 'C418 - Dreiton (Volume Beta)', url: '/Radio/18. Dreiton.mp3' },
  { title: 'C418 - The End (Volume Beta)', url: '/Radio/19. The End.mp3' },
  { title: 'C418 - Chirp (Volume Beta)', url: '/Radio/20. Chirp.mp3' },
  { title: 'C418 - Wait (Volume Beta)', url: '/Radio/21. Wait.mp3' },
  { title: 'C418 - Mellohi (Volume Beta)', url: '/Radio/22. Mellohi.mp3' },
  { title: 'C418 - Stal (Volume Beta)', url: '/Radio/23. Stal.mp3' },
  { title: 'C418 - Strad (Volume Beta)', url: '/Radio/24. Strad.mp3' },
  { title: 'C418 - Eleven (Volume Beta)', url: '/Radio/25. Eleven.mp3' },
  { title: 'C418 - Ward (Volume Beta)', url: '/Radio/26. Ward.mp3' },
  { title: 'C418 - Mall (Volume Beta)', url: '/Radio/27. Mall.mp3' },
  { title: 'C418 - Blocks (Volume Beta)', url: '/Radio/28. Blocks.mp3' },
  { title: 'C418 - Far (Volume Beta)', url: '/Radio/29. Far.mp3' },
  { title: 'C418 - Intro (Volume Beta)', url: '/Radio/30. Intro.mp3' }
]
